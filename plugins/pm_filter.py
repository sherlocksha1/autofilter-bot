...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/new_movies_group_2021"),
                InlineKeyboardButton("Series ⭕️", url="https://t.me/new_movies_group_2021")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/new_movies_group_2021'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/new_movies_group_2021')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/new_movies_group_2021)
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/new_movies_group_2021'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/new_movies_group_2021')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/new_movies_group_2021'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Movie", url="https://t.me/new_movies_group_20211"),
        InlineKeyboardButton("Series ⭕️", url="https://t.me/new_movies_group_2021")
    ])
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="hhttps://t.me/new_movies_group_2021)
    ])
